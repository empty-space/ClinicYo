...
/****** Object:  Database [Clinic_db]    Script Date: 04-Jun-17 20:29:20 ******/
CREATE DATABASE [Clinic_db]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Clinic_db', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.SQLEXPRESS\MSSQL\DATA\Clinic_db.mdf' , SIZE = 3072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Clinic_db_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.SQLEXPRESS\MSSQL\DATA\Clinic_db_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [Clinic_db] SET COMPATIBILITY_LEVEL = 120
GO
...
ALTER DATABASE [Clinic_db] SET RECOVERY SIMPLE 
GO
...
ALTER DATABASE [Clinic_db] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
